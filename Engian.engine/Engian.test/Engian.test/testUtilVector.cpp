...
namespace Test
{
  ...
  char const * const UnitTestChassis::TestUtilVector_VectorIteratorImpl_Constructor0( char const * const name )
  {
    try
    {
      ...
      TEST_ASSERT( DFT_FUNC_CHECK( Util::Vector< double >, "Vector< T >::VectorIteratorImpl::VectorIteratorImpl( T * const tArray )" ), 
  ...
  char const * const UnitTestChassis::TestUtilVector_VectorIteratorImpl_AdvanceValue( char const * const name )
  {
    try
    {
      ...
      TEST_ASSERT_EX( DFT_FUNC_CHECK( Util::Vector< UnitTestSampleStruct >, "void Vector< T >::VectorIteratorImpl::AdvanceValue()" ), 
  ...
  char const * const UnitTestChassis::TestUtilVector_VectorIteratorImpl_GetValue( char const * const name )
  {
    try
    {
      ...
      TEST_ASSERT_EX( DFT_FUNC_CHECK( Util::Vector< UnitTestSampleStruct >, "T const& Vector< T >::VectorIteratorImpl::GetValue() const" ), 
                      name, "Appropriate function was not called", delete [] structs );
    ...
    {
      {
        ...
        TEST_ASSERT( DFT_FUNC_CHECK( Util::Vector< bool >, "bool const Vector< T >::VectorIteratorImpl::operator==( IteratorImpl const& iterator ) const" ), 
                     name, "Appropriate function was not called" );
      }
  ...
  char const * const UnitTestChassis::TestUtilVector_Vector_Constructor0( char const * const name )
  {
    try
    {
      ...
      TEST_ASSERT( TestHelper_UtilVector< int >::CheckVectorInit( vector, Util::Vector< int >::dbgGet_c_defaultCapacity(), 0 ) == 0,
                   name, "did not initialize m_capacity, m_size, m_array, or m_implementations correctly" );

      TEST_ASSERT( DFT_FUNC_CHECK( Util::Vector< int >, "Vector< T >::Vector()" ), name, "Appropriate function was not called" );
    }
    catch( ... )
    {
      return TEST_EXCEPTION;
  ...
  char const * const UnitTestChassis::TestUtilVector_Vector_Constructor1( char const * const name )
  {
    try
    {
      ...
      TEST_ASSERT( TestHelper_UtilVector< int >::CheckVectorInit( vector, capacity, 0 ) == 0,
                   name, "did not initialize m_capacity, m_size, m_array, or m_implementations correctly" );
      TEST_ASSERT( DFT_FUNC_CHECK( Util::Vector< int >, "Vector< T >::Vector( unsigned const capacity )" ), 
                   name, "Appropriate function was not called" );
    }
    catch( ... )
    {
  ...
  char const * const UnitTestChassis::TestUtilVector_Vector_Constructor2( char const * const name )
  {
    try
    {
      ...
      TEST_ASSERT_EX( TestHelper_UtilVector< UnitTestSampleClass >::CheckVectorInit( vector, size, size ) == 0,
                      name, "did not initialize m_capacity, m_size, m_array, or m_implementations correctly", delete [] classes );
      TEST_ASSERT_EX( TestHelper_UtilVector< UnitTestSampleClass >::CheckVectorAgainstArray( vector, classes, size ) == 0,
                      name, "did not initialize with correct values", delete [] classes );
      TEST_ASSERT_EX( DFT_FUNC_CHECK( Util::Vector< UnitTestSampleClass > , "Vector< T >::Vector( T const * const tArray, unsigned const size )" ), 
  ...
  char const * const UnitTestChassis::TestUtilVector_Vector_Constructor3( char const * const name )
  {
    try
    {
      ...
      TEST_ASSERT( TestHelper_UtilVector< double >::CheckVectorInit( vector, list.dbgGet_m_size(), list.dbgGet_m_size() ) == 0,
                   name, "did not initialize m_capacity, m_size, m_array, or m_implementations correctly" );
      TEST_ASSERT( TestHelper_UtilVector< double >::CheckVectorAgainstContainer( vector, list ) == 0,
                   name, "did not initialize with correct values" );
      TEST_ASSERT( DFT_FUNC_CHECK( Util::Vector< double >, "Vector< T >::Vector( Container< T > const& container )" ), 
                   name, "Appropriate function was not called" );
    }
    catch( ... )
    {
  ...
  char const * const UnitTestChassis::TestUtilVector_Vector_CopyConstructor( char const * const name )
  {
    try
    {
      ...
      TEST_ASSERT( TestHelper_UtilVector< float >::CheckVectorInit( vector2, vector1.dbgGet_m_capacity(), vector1.dbgGet_m_size() ) == 0,
                   name, "did not initialize m_capacity, m_size, m_array, or m_implementations correctly" );
      TEST_ASSERT( vector2.dbgGet_m_array() != vector1.dbgGet_m_array(), name, "did not initialize m_array correctly" );
      TEST_ASSERT( TestHelper_UtilVector< float >::CheckVectorAgainstContainer( vector2, vector1 ) == 0,
                   name, "did not initialize with correct values" );
      TEST_ASSERT( DFT_FUNC_CHECK( Util::Vector< float >, "Vector< T >::Vector( Vector< T > const& vector )" ), 
                   name, "Appropriate function was not called" );
    }
    catch( ... )
    {
  ...
  char const * const UnitTestChassis::TestUtilVector_Vector_Begin( char const * const name )
  {
    try
    {
...

      {
        ...
        TEST_ASSERT( DFT_FUNC_CHECK( Util::Vector< char >, "Iterator Vector< T >::Begin() const" ), 
                     name, "Appropriate function was not called" );
      }
  ...
  char const * const UnitTestChassis::TestUtilVector_Vector_End( char const * const name )
  {
    try
    {
        ...
        vector.PushBack( (char)i );
      {
        ...
        TEST_ASSERT( DFT_FUNC_CHECK( Util::Vector< char >, "Iterator Vector< T >::End() const" ), 
                     name, "Appropriate function was not called" );
      }
  ...
  char const * const UnitTestChassis::TestUtilVector_Vector_PushFront( char const * const name )
  {
      ...
      TEST_ASSERT_EX( TestHelper_UtilVector< UnitTestSampleStruct >::CheckVectorInit( vector, size ) == 0,
                      name, "did not update m_capacity, m_size, m_array, or m_implementations correctly", delete [] testStructs );
      TEST_ASSERT_EX( TestHelper_UtilVector< UnitTestSampleStruct >::CheckVectorAgainstArray( vector, testStructs, size ) == 0,
                      name, "did not insert correct values", delete [] testStructs );
			TEST_ASSERT_EX( DFT_FUNC_CHECK( Util::Vector< UnitTestSampleStruct >, "void Vector< T >::PushFront( T const& t )" ),
  ...
  char const * const UnitTestChassis::TestUtilVector_Vector_PushBack( char const * const name )
  {
      ...
      TEST_ASSERT_EX( TestHelper_UtilVector< UnitTestSampleStruct >::CheckVectorAgainstArray( vector, testStructs, size ) == 0,
                      name, "did not insert correct values", delete [] testStructs );
			TEST_ASSERT_EX( DFT_FUNC_CHECK( Util::Vector< UnitTestSampleStruct >, "void Vector< T >::PushBack( T const& t )" ), 
                      name, "Appropriate function was not called", delete [] testStructs );
  ...
  char const * const UnitTestChassis::TestUtilVector_Vector_PopFront( char const * const name )
  {
      ...
      unsigned const size = 60;
        ...
        TEST_ASSERT_EX( TestHelper_UtilVector< UnitTestSampleStruct >::CheckVectorInit( vector, size ) == 0,
                        name, "did not update m_capacity, m_size, m_array, or m_implementations correctly", delete [] testStructs );
        TEST_ASSERT_EX( TestHelper_UtilVector< UnitTestSampleStruct >::CheckVectorAgainstArray( vector, testStructs + i + 1, size - 1 - i ) == 0,
			...
			TEST_ASSERT_EX( DFT_FUNC_CHECK( Util::Vector< UnitTestSampleStruct >, "void Vector< T >::PopFront()" ), 
                      name, "Appropriate function was not called", delete [] testStructs );
  ...
  char const * const UnitTestChassis::TestUtilVector_Vector_PopBack( char const * const name )
  {
      ...
      unsigned const size = 123;
        ...
        TEST_ASSERT_EX( TestHelper_UtilVector< UnitTestSampleStruct >::CheckVectorInit( vector, size - 1 - i ) == 0,
                        name, "did not update m_capacity, m_size, m_array, or m_implementations correctly", delete [] testStructs );
        TEST_ASSERT_EX( TestHelper_UtilVector< UnitTestSampleStruct >::CheckVectorAgainstArray( vector, testStructs, size - 1 - i ) == 0,
                        name, "stored values were not correct after", delete [] testStructs );
			}
			TEST_ASSERT_EX( vector.IsEmpty(), name, "Container< T >::IsEmpty() did not return true after", delete [] testStructs );

			TEST_ASSERT_EX( DFT_FUNC_CHECK( Util::Vector< UnitTestSampleStruct >, "void Vector< T >::PopBack()" ), 
                      name, "Appropriate function was not called", delete [] testStructs );
  ...
  char const * const UnitTestChassis::TestUtilVector_Vector_PopFirst( char const * const name )
  {
      ...
      TEST_ASSERT( DFT_FUNC_CHECK( Util::Vector< float >, "void Vector< T >::PopFirst( T const& t )" ), 
                   name, "Appropriate function was not called" );
		}
		catch( ... )
		{
  ...
  char const * const UnitTestChassis::TestUtilVector_Vector_PopAll( char const * const name )
  {
      ...
      TEST_ASSERT( DFT_FUNC_CHECK( Util::Vector< unsigned >, "void Vector< T >::PopAll( T const& t )" ), 
                   name, "Appropriate function was not called" );
		}
		catch( ... )
		{
  ...
  char const * const UnitTestChassis::TestUtilVector_Vector_Contains( char const * const name )
  {
    try
    {
      ...
      TEST_ASSERT( DFT_FUNC_CHECK( Util::Vector< long >, "bool const Vector< T >::Contains( T const& t ) const" ), 
                   name, "Appropriate function was not called" );
    }
    catch( ... )
    {
  ...
  char const * const UnitTestChassis::TestUtilVector_Vector_IsFull( char const * const name )
  {
    try
    {
      ...
      TEST_ASSERT( DFT_FUNC_CHECK( Util::Vector< Util::List< int > >, "bool const Vector< T >::IsFull() const" ), 
                   name, "Appropriate function was not called" );
    }
    catch( ... )
    {
  ...
  char const * const UnitTestChassis::TestUtilVector_Vector_GetCapacity( char const * const name )
  {
    try
    {
      ...
      TEST_ASSERT( DFT_FUNC_CHECK( Util::Vector< Util::List< int > >, "unsigned const Vector< T >::GetCapacity() const" ), 
                   name, "Appropriate function was not called" );
    }
    catch( ... )
    {
  ...
  char const * const UnitTestChassis::TestUtilVector_Vector_Clear( char const * const name )
  {
    try
    {
      ...
      TEST_ASSERT( DFT_FUNC_CHECK( Util::Vector< Util::List< UnitTestSampleStruct > >, "void Vector< T >::Clear()" ), 
                   name, "Appropriate function was not called" );
    }
    catch( ... )
    {
  ...
  char const * const UnitTestChassis::TestUtilVector_Vector_BasicAssignment0( char const * const name )
  {
    try
    {
      ...
      vector1 = vector2;
      TEST_ASSERT( TestHelper_UtilVector< int >::CheckVectorInit( vector1, vector2.dbgGet_m_capacity(), vector2.dbgGet_m_size() ) == 0,
                   name, "did not initialize m_capacity, m_size, m_array, or m_implementations correctly" );
      TEST_ASSERT( vector1.dbgGet_m_array() != vector2.dbgGet_m_array(), name, "assigned m_array, when it should have copied the values" );
      for( unsigned i = 0; i < number2; ++i )
        TEST_ASSERT( TestHelper_UtilVector< int >::CheckVectorAgainstContainer( vector1, vector2 ) == 0, name, "did not correctly copy values" );
      TEST_ASSERT( DFT_FUNC_CHECK( Util::Vector< int >, "Vector< T >& Vector< T >::operator=( Vector< T > const& vector )" ), 
                   name, "Appropriate function was not called" );
    }
    catch( ... )
    {
  ...
  char const * const UnitTestChassis::TestUtilVector_Vector_BasicAssignment1( char const * const name )
  {
    try
    {
      ...
      TEST_ASSERT( TestHelper_UtilVector< int >::CheckVectorInit( vector, number2 ) == 0, 
                   name, "did not initialize m_capacity, m_size, m_array, or m_implementations correctly" );      
      TEST_ASSERT( TestHelper_UtilVector< int >::CheckVectorAgainstContainer( vector, list ) == 0, name, "did not copy values correctly" );
      TEST_ASSERT( DFT_FUNC_CHECK( Util::Vector< int >, "Container< T >& Vector< T >::operator=( Container< T > const& container )" ), 
                   name, "Appropriate function was not called" );
    }
    catch( ... )
    {
  ...
  char const * const UnitTestChassis::TestUtilVector_Vector_ArraySubscript( char const * const name )
  {
    try
    {
      ...
      TEST_ASSERT( DFT_FUNC_CHECK( Util::Vector< double >, "T& Vector< T >::operator[]( int const index ) const" ), 
                   name, "Appropriate function was not called" );
    }
    catch( ... )
    {
  ...
  char const * const UnitTestChassis::TestUtilVector_Vector_Addition( char const * const name )
  {
    try
    {
      ...
      TEST_ASSERT( TestHelper_UtilVector< unsigned char >::CheckVectorInit( vector3, vector1.dbgGet_m_size() + vector2.dbgGet_m_size() ) == 0,
                   name, "did not initialize m_capacity, m_size, m_array, or m_implementations correctly" );
      ...
      TEST_ASSERT( TestHelper_UtilVector< unsigned char >::CheckVectorAgainstArray( vector3, vector1.dbgGet_m_array(), number1 ) == 0, 
                   name, "did not correctly assign values from first Vector< T >" );
      TEST_ASSERT( TestHelper_UtilVector< unsigned char >::CheckVectorAgainstArray( vector3, vector2.dbgGet_m_array(), number2 ) == 0, 
                   name, "did not correctly assign values from first Vector< T >" );
      TEST_ASSERT( DFT_FUNC_CHECK( Util::Vector< unsigned char >, "Vector< T > Vector< T >::operator+( Vector< T > const& vector ) const" ),
                   name, "Appropriate function was not called" );
    }
    catch( ... )
    {
  ...
  char const * const UnitTestChassis::TestUtilVector_Vector_AdditionAssignment( char const * const name )
  {
    try
    {
      ...
      TEST_ASSERT( TestHelper_UtilVector< unsigned char >::CheckVectorInit( vector1, number1 + number2 ) == 0,
                   name, "did not initialize m_capacity, m_size, m_array, or m_implementations correctly" );
      ...
      TEST_ASSERT( DFT_FUNC_CHECK( Util::Vector< unsigned char >, "Vector< T >& Vector< T >::operator+=( Vector< T > const& vector )" ), 
                   name, "Appropriate function was not called" );
    }
    catch( ... )
    {
  ...
  char const * const UnitTestChassis::TestUtilVector_Vector_Indirection( char const * const name )
  {
    try
    {
      ...
      TEST_ASSERT( DFT_FUNC_CHECK( Util::Vector< float >, "T const* Vector< T >::operator*() const" ), 
                   name, "Appropriate function was not called" );
    }
    catch( ... )
    {
